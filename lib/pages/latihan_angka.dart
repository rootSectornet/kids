...
class LatihanAngka extends StatefulWidget {
  @override
  _LatihanAngkaState createState() => _LatihanAngkaState();
}

class _LatihanAngkaState extends State<LatihanAngka>  with TickerProviderStateMixin implements LatihanAngkaView{

  LatihanAngkaModel _latihanAngkaModel;
  LatihanAngkaPresenter _latihanAngkaPresenter;
  _LatihanAngkaState(){
    this._latihanAngkaPresenter = new LatihanAngkaPresenter();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: WillPopScope(
        onWillPop: this._latihanAngkaPresenter.onWillpop,
                ...
                Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Center(child:Image.asset(this._latihanAngkaModel.soal.soal,fit: BoxFit.cover,),),
                      Align(
                        alignment: Alignment.centerRight,
                        child:Container(
                            transform: Matrix4.translationValues(-10.0, -20.0, 10.0),
                            child: Image.asset(this._latihanAngkaModel.soal.img,fit: BoxFit.fill,)
                        ),
                      ),
                    ],
                  ),
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (ctx,i){
                        return Container(
                          ...
                          child:InkWell(
                              onTap: (){this._latihanAngkaPresenter.Jawab(this._latihanAngkaModel.soal,this._latihanAngkaModel.soal.choice[i]);},
      ...
      floatingActionButton: Visibility(
        ...
        child: FloatingActionButton(
          onPressed: ()=>this._latihanAngkaPresenter.Play(),
  ...
  void initState() {
    ...
    MusicUtil.stopMusic();
    this._latihanAngkaPresenter.view = this;
    this._latihanAngkaPresenter.Play();
    super.initState();
  }
  @override
  void dispose() {
  ...
  void gantiSoal() {
    ...
    setState(() {
      this._latihanAngkaPresenter.getRandomSoal();
    });
  }
  ...
  void SelesaiSoal() {
    ...
    setState(() {
      this._latihanAngkaPresenter.Selesai();
    });
  }
